...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_action_server-msg:<FibonacciFeedback> is deprecated: use example_action_server-msg:FibonacciFeedback instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_action_server-msg:sequence-val is deprecated.  Use example_action_server-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FibonacciFeedback>)))
  ...
  "example_action_server/FibonacciFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FibonacciFeedback)))
  "Returns string type for a message object of type 'FibonacciFeedback"
  "example_action_server/FibonacciFeedback")
