...
bool operator==(const ::example_action_server::FibonacciFeedback_<ContainerAllocator1> & lhs, const ::example_action_server::FibonacciFeedback_<ContainerAllocator2> & rhs)
{
